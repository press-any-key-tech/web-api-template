...
aws cognito-idp admin-create-user --region eu-west-1 --user-pool-id <USERPOOL_ID> --username <USERNAME> --temporary-password <TMP_PASSWORD> --message-action SUPPRESS
aws cognito-idp admin-set-user-password --region eu-west-1 --user-pool-id <USERPOOL_ID> --username <USERNAME> --password <PASSWORD> --permanent
aws cognito-idp admin-add-user-to-group --region eu-west-1 --user-pool-id <USERPOOL_ID> --username <USERNAME> --group-name <GROUP>

```

- <USERPOOL_ID>: Cognito User Pool ID
- <USERNAME>: The user name.
- <TMP_PASSWORD>: Temporary password (used only for creation).
- <PASSWORD>: Definitive password
- <GROUP>: User group

### Insert concrete users

Admin

```bash

aws cognito-idp admin-create-user --region eu-west-1 --user-pool-id eu-west-1_StvNqnuLv --username user@mail.com --temporary-password user2024 --message-action SUPPRESS --user-attributes Name=email,Value=user@mail.com Name=email_verified,Value=true
aws cognito-idp admin-set-user-password --region eu-west-1 --user-pool-id eu-west-1_StvNqnuLv --username user@mail.com --password UseR2024! --permanent
aws cognito-idp admin-add-user-to-group --region eu-west-1 --user-pool-id eu-west-1_StvNqnuLv --username user@mail.com --group-name administrator
