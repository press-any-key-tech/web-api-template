...
from web_api_template.core.auth.utils import get_current_active_user
...
#         # TODO: Check if person exists (where? in the service? in the repository? in the controller? in the router? in the model?)
#         result: List[Policy] = await PolicyReadService().list(person_id=id)
#         return result
